Title: HITSP C32 v2.5 Schematron Package
...
v1.1 and HITSP/C80 Clinical Document and Message Terminology Component v1.1.  Please 
...
example -- Directory containing example file(s).
