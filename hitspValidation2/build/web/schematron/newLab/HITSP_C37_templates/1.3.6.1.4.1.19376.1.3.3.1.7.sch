...
<!ENTITY baseURI "">
<!ENTITY ent-1.3.6.1.4.1.19376.1.3.3.1.7 SYSTEM '1.3.6.1.4.1.19376.1.3.3.1.7.ent'>
]>
<schema xmlns="http://www.ascc.net/xml/schematron" xmlns:cda="urn:hl7-org:v3">
    ...
    <title>Template_1.3.6.1.4.1.19376.1.3.3.1.6</title>
    ...
    <phase id='errors'>
        ...
        <phase id='warnings'>
            <active pattern='p-1.3.6.1.4.1.19376.1.3.3.1.7-warning'/>
        </phase>
   <!--  
    <phase id='note'>
        <active pattern='p1.3.6.1.4.1.19376.1.3.3.1.2-note'/>
    </phase>
