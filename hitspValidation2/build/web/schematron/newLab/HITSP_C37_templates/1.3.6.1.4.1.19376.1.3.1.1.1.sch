...
<!ENTITY baseURI "">
<!ENTITY ent-1.3.6.1.4.1.19376.1.3.1.1.1 SYSTEM '1.3.6.1.4.1.19376.1.3.1.1.1.ent'>
]>
<schema xmlns="http://www.ascc.net/xml/schematron" xmlns:cda="urn:hl7-org:v3">
    ...
    <title>Template_1.3.6.1.4.1.19376.1.3.1.1.1</title>
    ...
    <phase id='note'>
        <active pattern='p1.3.6.1.4.1.19376.1.3.1.1.1-note'/>
    </phase>
    -->
