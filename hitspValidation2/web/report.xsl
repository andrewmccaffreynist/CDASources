...
-->
                ...
                <xsl:if test="count(Report/Results[@severity='fatalError']/issue) > 0">
                    <h3>Fatal Error:</h3>
                    <xsl:for-each select="Report/Results[@severity='fatalError']/issue">
                        <table cellpadding="3" cellspacing="3">
                            <xsl:attribute name="bgcolor">
                                <xsl:choose>
                                    <xsl:when test="(position() mod 2 = 1)">
                ...
                <xsl:if test="count(Report/Results[@severity='errors']/issue) > 0">
                    <h3>Schematron Errors:</h3>
                    <xsl:for-each select="Report/Results[@severity='errors']/issue">
                        <table cellpadding="3" cellspacing="3">
                            <xsl:attribute name="bgcolor">
                                <xsl:choose>
                                    <xsl:when test="(position() mod 2 = 1)">
                            ...
                            <tr>
                                <td>Specification</td>
                                <td>
                                    <xsl:value-of select="parent::Results/@specification"/>
                                </td>
                            </tr>                            
                        </table>
                    </xsl:for-each>
                ...
                <xsl:if test="count(Report/Results[@severity='warning']/issue) > 0">
                    <h3>Schematron Warnings:</h3>
                ...
                <xsl:if test="count(Report/Results[@severity='notes']/issue) > 0">
                    <h3>Schematron Notes:</h3>
                    <xsl:for-each select="Report/Results[@severity='notes']/issue">
                        <table cellpadding="3" cellspacing="3">
                            <xsl:attribute name="bgcolor">
                                <xsl:choose>
                                    <xsl:when test="(position() mod 2 = 1)">
