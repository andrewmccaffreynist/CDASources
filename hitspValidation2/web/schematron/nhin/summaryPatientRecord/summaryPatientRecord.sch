...
<schema xmlns="http://www.ascc.net/xml/schematron" xmlns:cda="urn:hl7-org:v3">
	...
	<phase id="warning">
	     ...
	     <active pattern="AllergiesDrugModuleWarning" />
	     <active pattern="ConditionsModuleWarning" />
	     <active pattern="MedicationsModuleWarning" />
	</phase>
	...
	<pattern id="SupportModule" name="SupportModule">
		<rule context="/cda:ClinicalDocument">
	     ...
	     -->
			<assert
				test="cda:recordTarget/cda:patientRole/cda:patient/cda:guardian or cda:participant"
	    ...
	    -->
	     ...
	     <rule context="/cda:ClinicalDocument">
	         <assert test=".//cda:templateId/@root='2.16.840.1.113883.10.20.1.2'">
	             Error: In Summary Patient Record, Alert (Allergies and Drug Sensitivities) Module is a
		  required Module.
	         </assert>
               </rule>
	    <rule context="//cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.1.2']/cda:entry/cda:act">
	        <assert test="./cda:templateId[@root='2.16.840.1.113883.3.88.11.32.6']">
	            Error: This Summary Patient Record contains a CCD template ID for Alerts (2.16.840.1.113883.10.20.1.2), and an entry act
	            with no corresponding C32 template ID (2.16.840.1.113883.3.88.11.32.6).
                    </assert>	        	        
	    </rule>
	</pattern>
           <pattern id="AllergiesDrugModuleWarning" name="AllergiesDrugModuleWarning">
               <rule context="/cda:ClinicalDocument//cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.1.2']">
                   <assert test=".//cda:templateId/@root='2.16.840.1.113883.3.88.11.32.6'">
                       Warning: This Summary Patient Record contains a CCD template ID for Alerts (2.16.840.1.113883.10.20.1.2)
                       but no corresponding C32 template ID for any entry (2.16.840.1.113883.3.88.11.32.6).
                   </assert>
               </rule>
           </pattern>
	<pattern id="ConditionsModule" name="ConditionsModule">
		...
		<rule context="/cda:ClinicalDocument">
		    <assert test=".//cda:templateId/@root='2.16.840.1.113883.10.20.1.11'"
	            ...
	            <rule context="//cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.1.11']/cda:entry/cda:act">
	                <assert test="./cda:templateId[@root='2.16.840.1.113883.3.88.11.32.7']">
	                    Error: This Summary Patient Record contains a CCD template ID for Conditions (problem) Section (2.16.840.1.113883.10.20.1.11), and an entry act
	                    with no corresponding C32 template ID (2.16.840.1.113883.3.88.11.32.7).
	                </assert>	        	        
	            </rule>
	</pattern>
            <pattern id="ConditionsModuleWarning" name="ConditionsModulesWarning">
                <rule context="/cda:ClinicalDocument//cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.1.11']">
                    <assert test=".//cda:templateId/@root='2.16.840.1.113883.3.88.11.32.7'">
                        Warning: This Summary Patient Record contains a CCD template ID for Conditions (problem) (2.16.840.1.113883.10.20.1.11)
                        but no corresponding C32 template ID for any entry (2.16.840.1.113883.3.88.11.32.7).
                    </assert>
                </rule>
            </pattern>
		...
		<rule context="/cda:ClinicalDocument">
	     ...
	     -->
			<assert
	           ...
	           <rule context="//cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.1.8']/cda:entry/cda:substanceAdministration">
		    <assert test="./cda:templateId[@root='2.16.840.1.113883.3.88.11.32.8']">
		         Error: This Summary Patient Record contains a CCD template ID for Medications Section (2.16.840.1.113883.10.20.1.8),
		         and an entry/substanceAdministration with no corresponding C32 template ID (2.16.840.1.113883.3.88.11.32.8).
		    </assert>	        	        		    
		</rule>	    	    
	</pattern>
           <pattern id="MedicationsModuleWarning" name="MedicationsModulesWarning">
                <rule context="/cda:ClinicalDocument//cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.1.8']">
                    <assert test=".//cda:templateId/@root='2.16.840.1.113883.3.88.11.32.8'">
                        Warning: This Summary Patient Record contains a CCD template ID for Medications (2.16.840.1.113883.10.20.1.8)
                        but no corresponding C32 template ID for any entry/substanceAdministration (2.16.840.1.113883.3.88.11.32.8).
                    </assert>
                </rule>
           </pattern>
    ...
    <pattern id='ReligiousAffiliation' name='ReligiousAffiliation'>
        <rule context='/cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:religiousAffiliationCode'>
            <assert test='@nullFlavor or @codeSystem="2.16.840.1.113883.5.1076" and
                document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/codeSystems.xml")/systems/system[@root="2.16.840.1.113883.5.1076"]/code[@value = current()/@code]'>
    ...
    <pattern id='RaceCode' name='RaceCode'>
        <rule context='/cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:raceCode |
            ...
            <assert test='@nullFlavor or @codeSystem="2.16.840.1.113883.6.238" and
                document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/codeSystems.xml")/systems/system[@root="2.16.840.1.113883.6.238"]/code[@value = current()/@code]'>
    ...
    <pattern name="HumanLanguage" id="HumanLanguage">
        <rule context='/cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:languageCommunication/cda:languageCode'>
            <assert test='@nullFlavor or
                ...
                and
                substring( current()/@code , 1, 2 ) = document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/codeSystems.xml")/systems/system[@root="2.16.840.1.113883.6.121"]/code/@value
                and
                substring( current()/@code , 3, 1 ) = "-"
                and
                substring( current()/@code, 4, 2) = document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/codeSystems.xml")/systems/system[@root="2.16.1"]/code/@value                                
                )                
                or
                (
                string-length(current()/@code) = 6
                and
                substring( current()/@code , 1, 3 ) = document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/codeSystems.xml")/systems/system[@root="2.16.840.1.113883.6.121"]/code/@value
                and
                substring( current()/@code , 4, 1 ) = "-"
                and
                substring( current()/@code, 5, 2) = document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/codeSystems.xml")/systems/system[@root="2.16.1"]/code/@value                                
                )
                ' >                
    ...
    <pattern id='HumanLanguage' name='HumanLanguage'>
        <rule context='/cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:languageCommunication/cda:languageCode'>
        	<assert test='@nullFlavor or document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/codeSystems.xml")/systems/system[@root="2.16.840.1.113883.6.121"]/code[@value = current()/@code]'>
                Error: In Summary Patient Record, human langauge SHALL use
                a code from the specified list (value set OID: 2.16.840.1.113883.1.11.11526). 
                See NHIN Core Content Specificiation for Exchange of Summary Patient Record (April 2008) document and related spreadsheet.
            </assert>
    ...
    <pattern id='ContactRelationship' name='ContactRelationship'>
        <rule
            ...
            <assert test='@nullFlavor or @codeSystem="2.16.840.1.113883.5.111" and
                document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/codeSystems.xml")/systems/system[@root="2.16.840.1.113883.5.111"]/code[@value = current()/@code]'>
    ...
    <pattern id='ProviderType' name='ProviderType'>
        <rule context='/cda:ClinicalDocument/cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity/cda:code'>
            <assert test='@nullFlavor or @codeSystem="2.16.840.1.113883.6.101" and
                document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/codeSystems.xml")/systems/system[@root="2.16.840.1.113883.6.101"]/code[@value = current()/@code]'>
    ...
    <pattern id='RoleClassRelationshipFormal' name='RoleClassRelationshipFormal'>
        <rule context='//cda:act[cda:templateId/@root="2.16.840.1.113883.10.20.1.26"]/cda:performer/cda:assignedEntity/cda:code'>
            <assert test='@nullFlavor or @codeSystem="2.16.840.1.113883.5.110" and
                document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/codeSystems.xml")/systems/system[@root="2.16.840.1.113883.5.110"]/code[@value = current()/@code]'>
    ...
    <pattern id="AdverseEventProduct" name="AdverseEventProduct">
        <rule context='//cda:act[cda:templateId/@root="2.16.840.1.113883.10.20.1.27"]/cda:entryRelationship[@typeCode="SUBJ"]/cda:observation[cda:templateId/@root="2.16.840.1.113883.10.20.1.18"]/cda:participant[@typeCode="CSM"]/cda:participantRole[@classCode="MANU"]/cda:playingEntity[@classCode="MMAT"]/cda:code'> 
            <assert test='@nullFlavor or 
                ...
                (@codeSystem="2.16.840.1.113883.4.9" and document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/unii.xml")/systems/system[@root="2.16.840.1.113883.4.9"]/code[@value = current()/@code]) or
                (@codeSystem="2.16.840.1.113883.4.209" and document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/ndf-rt.xml")/systems/system[@root="2.16.840.1.113883.4.209"]/code[@value = current()/@code]) or
    ...
    <pattern id='ProblemListSubset' name='ProblemListSubset'>
        <rule context='//cda:observation[cda:templateId/@root="2.16.840.1.113883.10.20.1.54"]/cda:value |
            ...
            <assert test='@nullFlavor or @codeSystem="2.16.840.1.113883.6.96" and
				document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/problemListSubset.xml")/systems/system[@root="2.16.840.1.113883.6.96"]/code[@value = current()/@code]'>
   ...
   <pattern id='ProblemStatus' name='ProblemStatus'>
        ...
        context='//cda:act[cda:templateId/@root="2.16.840.1.113883.10.20.1.27"]/cda:entryRelationship[@typeCode="SUBJ"]/cda:observation[cda:templateId/@root="2.16.840.1.113883.10.20.1.28"]/cda:entryRelationship/cda:observation[cda:code/@code="33999-4"]/cda:value'>
            <assert test='@nullFlavor or (@codeSystem="2.16.840.1.113883.6.96" and
                document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/codeSystems.xml")/systems/system[@root="2.16.840.1.113883.6.96"]/code[@value = current()/@code])'>
    ...
    <pattern id='RouteOfAdministration' name='RouteOfAdministration'>
        <rule context='//cda:substanceAdministration[cda:templateId/@root="2.16.840.1.113883.10.20.1.24"]/cda:routeCode'>
            <assert test='@nullFlavor or @codeSystem="2.16.840.1.113883.3.26.1.1" and
                document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/codeSystems.xml")/systems/system[@root="2.16.840.1.113883.3.26.1.1"]/code[@value = current()/@code]'>
    ...
    <pattern id='VaccineProduct' name='VaccineProduct'>
        <rule context='//cda:substanceAdministration[cda:templateId/@root="2.16.840.1.113883.10.20.1.24" and cda:templateId/@root="2.16.840.1.113883.3.88.11.32.14"]/cda:consumable/cda:manufacturedProduct/cda:manufacturedMaterial/cda:code'>
            <assert test='@nullFlavor or @codeSystem="2.16.840.1.113883.6.59" and
                document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/codeSystems.xml")/systems/system[@root="2.16.840.1.113883.6.59"]/code[@value = current()/@code]'>
    ...
    <pattern id="ResultType" name="ResultType">
        <rule context='//cda:observation[cda:templateId/@root="2.16.840.1.113883.10.20.1.14" and cda:templateId/@root="2.16.840.1.113883.3.88.11.32.16"]/cda:code'>            
            <assert test='@nullFlavor or @codeSystem = "2.16.840.1.113883.6.1" and
                document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/resultType.xml")/systems/system[@root="2.16.840.1.113883.6.1"]/code[@value = current()/@code]'>
    ...
    <pattern id='ObservationInterpretation' name='ObservationInterpretation'>       
        <rule context='//cda:observation[cda:templateId/@root="2.16.840.1.113883.10.20.1.14" and cda:templateId/@root="2.16.840.1.113883.3.88.11.32.15"]/cda:interpretationCode |
            ...
            <assert test='@nullFlavor or @codeSystem="2.16.840.1.113883.5.83" and
                document("http://localhost:11080/hitspValidation/schematron/nhin/summaryPatientRecord/codeSystems.xml")/systems/system[@root="2.16.840.1.113883.5.83"]/code[@value = current()/@code]'>
                Error: In Summary Patient Record, result status SHALL use
