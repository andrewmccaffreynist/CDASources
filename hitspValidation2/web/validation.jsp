...
<jsp:useBean id="validation" scope="session" class="gov.nist.hitsp.validation.ValidationHelper2" />
<% validation.processRequest(request); %>
...
<b>Note: NIST cannot guarantee 24/7 access to this on-line service.  If you have mission-critical work dependent on access to this service, please consider using the available downloadable version as a service local to you.  Thank you.</b>
