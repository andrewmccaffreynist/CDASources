...
<html>
    <head>
        ...
        <title>Meaningful Use IG for Ambulatory Healthcare Provider Reporting to Central Cancer Registries Validation</title>
    </head>
    
    <body>

        <h2>Meaningful Use Cancer Registry Report Validation</h2>
           ...
           <form method="post" enctype="multipart/form-data" action="validationResultXml.jsp" name="myform">
            <table class="standard" >
                <tr bgcolor="#EEEEFF">
                    ...
                    <td>
         Upload your Cancer Registry Report XML document for validation: <input type="file" id="file" name="file" size="50" />
                   </td>
                </tr>
                <tr bgcolor="#CCCCDD">
                    <td>
